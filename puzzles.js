...
//      做得到象棋做不到的嚴格證明)。
//   ② 題名用「殺法模式」的通稱(後排殺/雙城堡梯殺…),不冒名任何棋書名局。
//   ③ FEN 是標準格式,白方先走。
...
export const DAILY_PUZZLES = [
  ...
  { id: "back-rank-1", name: "後排殺", mateIn: 1,
    hint: "黑國王被自己的兵關在底線——一支城堡就夠!",
    fen: "6k1/5ppp/8/8/8/8/5PPP/R5K1 w - - 0 1" },
  { id: "ladder-final", name: "雙城堡收官", mateIn: 1,
    hint: "一支城堡封住第七排,另一支城堡下最後通牒!",
    fen: "k7/6R1/8/8/8/8/8/6KR w - - 0 1" },
  { id: "queen-kiss", name: "貼身皇后", mateIn: 1,
    hint: "皇后走到黑國王臉上——有國王護駕就吃不掉她!",
    fen: "6k1/5ppp/8/8/8/8/5PPP/3Q2K1 w - - 0 1" },
  { id: "smother-ready", name: "悶殺一擊", mateIn: 1,
    hint: "黑國王被自己人擠得沒地方走——騎士跳進去就結束!",
    fen: "6rk/6pp/8/6N1/8/8/6PP/6K1 w - - 0 1" },
  { id: "diag-snipe", name: "斜線狙擊", mateIn: 1,
    hint: "皇后沿斜線瞄到角落的國王——一步到位!",
    fen: "7k/6pp/8/8/8/8/1Q4PP/6K1 w - - 0 1" },
  { id: "rook-lift", name: "側翼突襲", mateIn: 1,
    hint: "國王被擠在邊路——城堡從側面一擊!",
    fen: "7k/8/6K1/8/8/8/8/R7 w - - 0 1" },

  // ── 兩步殺 ──
  { id: "ladder-mate", name: "雙城堡梯殺", mateIn: 2,
    hint: "兩支城堡像爬樓梯:一支將軍逼國王後退,另一支封路!",
    fen: "8/1k6/6R1/7R/8/8/8/6K1 w - - 0 1" },
  { id: "rooks-wall-2", name: "雙城堡圍城", mateIn: 2,
    hint: "一支城堡先封六排斷退路,另一支城堡把國王逼上底線!",
    fen: "8/2k5/5R2/7R/8/8/8/6K1 w - - 0 1" },
  { id: "corner-squeeze", name: "牆角圍捕", mateIn: 2,
    hint: "先用皇后把國王釘在角落,再叫幫手收尾!",
    fen: "7k/8/5N2/8/8/8/1Q6/6K1 w - - 0 1" },
  { id: "l-shape-rooks", name: "直角雙城堡", mateIn: 2,
    hint: "兩支城堡一橫一豎擺出直角——國王往哪邊躲都來不及!",
    fen: "4k3/8/R7/1R6/8/8/8/6K1 w - - 0 1" },
  { id: "rooks-chase-2", name: "雙城堡趕王", mateIn: 2,
    hint: "先封住國王腳下那一排,再從側面下最後通牒!",
    fen: "8/4k3/1R6/R7/8/8/8/6K1 w - - 0 1" },
  { id: "queen-corner-2", name: "皇后逼角", mateIn: 2,
    hint: "自己的國王已經站好位——皇后繞到底線收網!",
    fen: "6k1/8/5K2/8/8/8/2Q5/8 w - - 0 1" },
  { id: "queen-hunt", name: "皇后獵王", mateIn: 2,
    hint: "先讓自己的國王貼上去堵路,皇后再一擊致命!",
    fen: "7k/8/8/5K2/8/8/1Q6/8 w - - 0 1" },

  // ── 三步殺(進階)──
  { id: "ladder-3", name: "長梯趕王", mateIn: 3,
    hint: "雙城堡輪流將軍,把國王一排一排趕到底線!",
    fen: "8/8/1k6/6R1/7R/8/8/6K1 w - - 0 1" },
  { id: "rook-box", name: "城堡合圍", mateIn: 3,
    hint: "城堡畫出牢籠,自己的國王上前一步步收網!",
    fen: "4k3/8/8/3K4/8/8/8/7R w - - 0 1" },
  { id: "rooks-march-3", name: "雙城堡長征", mateIn: 3,
    hint: "國王還在半路上——雙城堡輪流將軍,三步把他押到底線!",
